...
class model_uncertainty_model
  : public stan::model::model_base_crtp<model_uncertainty_model> {
private:
        int N;
        int K;
        int C;
...
public:
    ...
    std::string model_name() const {
        return "model_uncertainty_model";
    }
...
typedef model_uncertainty_model_namespace::model_uncertainty_model stan_model;
#ifndef USING_R
