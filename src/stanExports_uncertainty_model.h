...
namespace model_uncertainty_model_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 30, column 4 to column 41)",
                                                      " (in 'string', line 34, column 6 to column 52)",
                                                      " (in 'string', line 33, column 9 to line 35, column 5)",
                                                      " (in 'string', line 32, column 6 to column 46)",
                                                      " (in 'string', line 31, column 16 to line 33, column 5)",
                                                      " (in 'string', line 31, column 4 to line 35, column 5)",
                                                      " (in 'string', line 29, column 16 to line 36, column 3)",
                                                      " (in 'string', line 29, column 2 to line 36, column 3)",
                                                      " (in 'string', line 20, column 2 to column 36)",
                                                      " (in 'string', line 21, column 2 to column 24)",
                                                      " (in 'string', line 22, column 2 to column 37)",
                                                      ...
                                                      " (in 'string', line 16, column 14 to column 15)",
                                                      " (in 'string', line 17, column 9 to column 10)",
                                                      " (in 'string', line 27, column 26 to column 27)",
                                                      " (in 'string', line 28, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_uncertainty_model final : public model_base_crtp<model_uncertainty_model> {
private:
  int N;
  int K;
  int C;
...
public:
  ~model_uncertainty_model() { }
  
  inline std::string model_name() const final { return "model_uncertainty_model"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_uncertainty_model(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_uncertainty_model_namespace::model_uncertainty_model";
    ...
    try {
      ...
      context__.validate_dims("data initialization","xbar","double",
          context__.to_vec(K));
      xbar = Eigen::Matrix<double, -1, 1>(K);
      ...
      
      {
        ...
        for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
          current_statement__ = 33;
          assign(xbar, cons_list(index_uni(sym1__), nil_index_list()),
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_uncertainty_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      eta = in__.vector(K);
      {
        ...
        lp_accum__.add(
          normal_lpdf<propto__>(y, multiply(x, beta), multiply(sigma, u)));
        current_statement__ = 18;
        lp_accum__.add(
          normal_lpdf<propto__>(beta, add(xbar, multiply(sigma, eta)), sigma));
        current_statement__ = 19;
        lp_accum__.add(
          normal_lpdf<propto__>(y_diff,
            subtract(
              rvalue(beta,
                cons_list(
                  index_multi(rvalue(c,
                                ...
                                "c")), nil_index_list()), "beta"),
              rvalue(beta,
                cons_list(
                  index_multi(rvalue(c,
                                cons_list(index_omni(),
                                  cons_list(index_uni(2), nil_index_list())),
                                "c")), nil_index_list()), "beta")), sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      error = Eigen::Matrix<double, -1, 1>(C);
      stan::math::fill(error, std::numeric_limits<double>::quiet_NaN());
      
      Eigen::Matrix<double, -1, 1> q;
      q = Eigen::Matrix<double, -1, 1>(C);
      ...
      for (int k = 1; k <= C; ++k) {
        ...
        assign(q, cons_list(index_uni(k), nil_index_list()),
          (beta[(c[(k - 1)][(1 - 1)] - 1)] - beta[(c[(k - 1)][(2 - 1)] - 1)]),
          "assigning variable q");
        current_statement__ = 12;
        if (logical_lt(0, q[(k - 1)])) {
          current_statement__ = 10;
          assign(error, cons_list(index_uni(k), nil_index_list()),
            (normal_cdf(0, q[(k - 1)], sigma) * 2),
            "assigning variable error");
        } else {
          current_statement__ = 8;
          assign(error, cons_list(index_uni(k), nil_index_list()),
            ((1 - normal_cdf(0, q[(k - 1)], sigma)) * 2),
            "assigning variable error");
        }}
      ...
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        current_statement__ = 5;
        current_statement__ = 5;
        check_greater_or_equal(function__, "error[sym1__]",
                               error[(sym1__ - 1)], 0);}
      current_statement__ = 5;
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        current_statement__ = 5;
        current_statement__ = 5;
        check_less_or_equal(function__, "error[sym1__]", error[(sym1__ - 1)],
                            1);}
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        vars__.emplace_back(error[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
  ...
  inline void constrained_param_names(
    ...
    if (emit_generated_quantities__) {
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "error" + '.' + std::to_string(sym1__));
        }}
      for (int sym1__ = 1; sym1__ <= C; ++sym1__) {
        {
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_diff\",\"type\":{\"name\":\"array\",\"length\":" << C << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"error\",\"type\":{\"name\":\"vector\",\"length\":" << C << "},\"block\":\"generated_quantities\"},{\"name\":\"q\",\"type\":{\"name\":\"vector\",\"length\":" << C << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_uncertainty_model_namespace::model_uncertainty_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_uncertainty_model_namespace::profiles__;
}
#endif
#endif
