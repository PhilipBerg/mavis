...
static constexpr std::array<const char*, 24> locations_array__ =
  ...
  " (in 'string', line 21, column 4 to column 63)",
  " (in 'string', line 23, column 4 to column 21)",
  " (in 'string', line 25, column 4 to column 48)",
  " (in 'string', line 19, column 17 to line 26, column 3)",
  " (in 'string', line 19, column 2 to line 26, column 3)",
  ...
  " (in 'string', line 4, column 2 to column 41)",
  " (in 'string', line 5, column 29 to column 30)",
  " (in 'string', line 5, column 2 to column 36)",
  " (in 'string', line 9, column 18 to column 19)",
  " (in 'string', line 10, column 18 to column 19)",
  " (in 'string', line 11, column 29 to column 30)"};
