...
vignette: >
  ...
  %\VignetteEngine{knitr::render_html}
...
yeast_cluster_imp <- yeast_cluster %>% 
  single_imputation(yeast_design, sd ~ mean)
```
...
yeast_cluster_imp <- gam_reg_imp %>% 
  estimate_gamma_hyperparameters(yeast_cluster_imp, design_matrix = yeast_design)
